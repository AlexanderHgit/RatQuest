...
function handle_move(m)
  ...
  if cansee(m, p_mob) then
      m.tx, m.ty = p_mob.x, p_mob.y
      addfloat(tostr(m.spec), m.x * 8 + 2, m.y * 8, 10)
      if m.spec=="boss" and fightingboss==false then 
        fightingboss=true
        for _x=0,15 do
          for _y=0,15 do
            addfloat("?", m.x * 8 + 2, m.y * 8, 10)
...
__gff__

