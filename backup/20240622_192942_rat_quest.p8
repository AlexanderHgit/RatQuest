...
function handle_move(m)
  ...
  if cantmoveallharm(m.x,m.y)==false then
    m.tx, m.ty =  m.last_safe["lx"], m.last_safe["ly"]
    addfloat(tostr(m.last_safe["lx"]..","..m.last_safe["ly"]),m.tx,m.ty,9)
  end
...

