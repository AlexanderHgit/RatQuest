...
function handle_move(m)
  aaa=cantmoveallharm(m.x,m.y)
  if cansee(m, p_mob) then
      m.tx, m.ty = p_mob.x, p_mob.y
      addfloat("tryna move",m.x*8+2,m.y*8,10)
  end
  if cantmoveallharm(m.x,m.y) then
    m.tx, m.ty =  m.last_safe["lx"], m.last_safe["ly"]
    addfloat("true thos",m.x*8+2,m.y*8,10)
  end
  if m.x == m.tx and m.y == m.ty then
      m.task = ai_wait
      addfloat("waiting",m.x*8+2,m.y*8,10)
      return true
  end
  addfloat(tostr(aaa),m.x*8+2,m.y*8,10)
...
__gff__

...

...

...

