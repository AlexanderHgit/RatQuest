...
inventorySize=8
 ...
 number_of_non_chest_items=3
 testNames="knife,sword,club,raincoat,cool hat,food 1,food 2,rock,big rock,crumbling wall,lava,tile graber"
 testTypes="wep,wep,wep,arm,arm,fud,fud,thr,thr,tle,tle,spec"
 testStats1="1,2,1,0,0,1,2,999,999,3,106,1"
 testStats2="0,0,0,1,2,0,0,0,0,0,1"
 testStats3="0,0,0,1,1,0,0,-2,0,0,0,1"
 testStatsDurability="1,3,4,1,4,0,0,0,0,0,0,1"
--[[ 
...
function ai_wonder(m)
  ...
  if m.turns_since_last_seen > 6 then
    m.task=ai_wait
    addfloat("...",m.x*8+2,m.y*8,10)
  end
...
if m.task==ai_wonder then 
  local random_dir=flr(rnd(4))
  if (iswalkable(dirx[random_dir], diry[random_dir], "checkmobs") and iswalkable(dirx[random_dir], diry[random_dir], "checkspike")) then
   mobwalk(m,dirx[random_dir],diry[random_dir])
  end
  return true
end
...

